...
$sql = "SELECT candidate_id, name, course_name, year_section, position_name, election_id, election_name, status 
        FROM view_for_eballot
        WHERE election_id = ? 
        ORDER BY FIELD(position_name, 'President', 'Vice President', 'Secretary', 'Auditor', 'Treasurer', 'Business Manager', 'Creative Committee', 'First Year Representative', 'Second Year Representative', 'Third Year Representative', 'Fourth Year Representative'), position_name, name";
