...
<div class="wrapper">
        ...
        <div class="main-content container-fluid g-0">
            ...
            <div class="container mt-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Archived Facilitators List</h2>
                </div>


                <table class="table table-bordered text-center" id="archiveFacilitatorsTable">
                    <thead>
                        <tr>
                            <th class="id-column">Facilitator ID</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="restoreModalLabel">Restore Facilitator</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Are you sure you want to restore <span id="restoreFacilitatorName" class="fw-bold"></span>?
            </div>
    ...
    <script>
        $(document).ready(function () {
            function fetchArchivedFacilitators() {
    $.ajax({
        url: '../fetch_archived_facilitators.php',
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            ...
            if (data.length > 0) {
                    ...
                    rows += `<tr>
                        ...
                        <td>
                            <button
                                ...
                                data-id="${facilitator.facilitator_id}"
                ...
                rows = "<tr><td colspan='3'>No archived facilitators found</td></tr>";
            }
            $('#archiveFacilitatorsTable tbody').html(rows);
        },
        error: function () {
            $('#archiveFacilitatorsTable tbody').html(
                "<tr><td colspan='3'>Error fetching data</td></tr>"
            );
        }
    });
}
            fetchArchivedFacilitators();




      $(document).on('click', '.restore-btn', function () {
        const facilitatorId = $(this).data('id');
        const facilitatorName = $(this).data('name');
        $('#restoreFacilitatorName').text(facilitatorName);
        $('#confirmRestore').data('id', facilitatorId);
    ...
    $('#confirmRestore').click(function () {
        ...
        $.ajax({
            ...
            error: function () {
                alert('Error restoring facilitator');
            }
        });
    });
});
        ...
        document.getElementById("searchInput").addEventListener("keyup", function() {
            ...
            table = document.getElementById("archiveFacilitatorsTable");
