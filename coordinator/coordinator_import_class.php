   ...
   <!------------------------------------------------------ Main Content ------------------------------------------------------>
        ...
        <div class="main-content container-fluid g-0">
            ...
            <div class="title-container">
                <h1>Coordinator: Import Class List</h1>
            </div>
            ...
            <div class="container mt-3">
                <div class="alert alert-info">
                    ...
                    <ul>
                        <li><strong>Header:</strong> Student ID, Last Name, First Name, Middle Name, Gender, Course, Year-Section </li>
                        <li><strong>Example:</strong> 20220123-N, Dela Cruz, Juan, Fernandez, Male/Female, BSCS, 1-A</li>
